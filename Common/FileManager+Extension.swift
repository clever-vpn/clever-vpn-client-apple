...
extension FileManager {
    static var appGroupId: String? {
        #if os(iOS)
        let appGroupIdInfoDictionaryKey = "com.clever_vpn_kit.app_group_id"
        #elseif os(macOS)
        let appGroupIdInfoDictionaryKey = "com.clever_vpn_kit.app_group_id"
        #else
        #error("Unimplemented")
    ...
    static var userInfoURL: URL? {
        return sharedFolderURL?.appendingPathComponent("clever-vpn-kit-userInfo.json")
    }
    
    static var licenceURL: URL? {
        return sharedFolderURL?.appendingPathComponent("clever-vpn-kit-licence.json")
    }
    
    static var locationsURL: URL? {
        return sharedFolderURL?.appendingPathComponent("clever-vpn-kit-locations.json")
    }
